          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-brand-600/20 to-indigo-600/20 border border-brand-500/30 rounded-3xl p-12 backdrop-blur-sm">
              ...
              <div className="max-w-4xl mx-auto mb-8">
                <div className="relative bg-gradient-to-br from-indigo-900/50 to-purple-900/50 backdrop-blur-sm rounded-2xl p-8 border border-indigo-500/50">
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  ...
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-semibold text-white mb-2">Site Totalmente Personalizado</h3>
                    <p className="text-slate-300 text-sm">Desenvolvimento dedicado com entrega garantida em 30 dias</p>
                  </div>
                  <div className="text-center mb-6">
                    <div className="text-4xl font-bold text-indigo-300">
                      <span className="text-lg text-slate-400">A partir de </span>
                      R$ 19.900
                      <span className="text-sm text-slate-400 block mt-1">Pagamento único</span>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-full font-medium transition-all shadow-xl hover:shadow-2xl hover:scale-105 text-sm sm:text-base"
                    >
                      ...
                      <span className="whitespace-nowrap">Falar com o Diretor de Tecnologia</span>
                    </a>
                  </div>
                </div>
              </div>
