...
export default function ConstellationDashboard() {
        ...
        <div className="max-w-2xl w-full bg-slate-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-800/50 p-8 text-center">
          ...
          <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-xl mb-6">
            ...
            <p className="text-sm text-slate-400">
              ...
              Status: <span className="text-amber-400">Payment Pending</span>
            </p>
          </div>
          ...
          <p className="text-sm text-slate-400 mt-6">
            We'll notify you when everything is ready after your payment is confirmed.
          </p>
        </div>
      </div>
    )
  ...
  // User has paid - show success message (dashboard will be built later)
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-slate-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-800/50 p-8 text-center">
        ...
        <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-xl mb-6">
          ...
          <p className="text-slate-300">
            We will notify you when your Constellation dashboard is ready.
          </p>
        </div>
